...
class Order(models.Model):
    company = models.ForeignKey(CompanyDetails,on_delete=models.SET_NULL ,null=True)
    user = models.ForeignKey(User,on_delete=models.SET_NULL ,null=True) 
...
class OrderItem(models.Model):
    ...
    digitalResource = models.FileField(upload_to='order_digital_resources/', null=True, blank=True, editable=False)
    _id = models.AutoField(primary_key=True,editable=False)
