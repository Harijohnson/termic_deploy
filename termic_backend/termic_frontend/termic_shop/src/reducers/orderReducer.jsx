import { 
    ...
    ORDER_DELIVERED_RESET,} from '../constants/OrderConstant'
...
export const ordeDeliveredReducer = (state={},action) => {
    switch (action.type){
